...
# Executable version
A precompiled version under Linux 64bit (HybridStride_Linux_64) can be directly downloaded and executed. 
...
If the all-in-one script does not fit your datasets, you can execute each command line in the sample bash script and adjust the parameters for your own needs.
	...
	HybridStride_Linux_64 preprocesss --discard-quality -p 1 R1.fq R2.fq -o reads.fa
	HybridStride_Linux_64 index -t reads.fa
	HybridStridev index -t PB.fa
	...
